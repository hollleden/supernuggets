...
async function loadStats(): Promise<Stats> {
  ...
  // Per-folder counts (skip 'all' — that's the filter pseudo-folder)
  ...
  // Daily streak — consecutive days from today (or yesterday if today has none)
  ...
  return (
    <>
      ...
      <div className="max-w-5xl mx-auto px-4 py-8 md:py-12">
        ...
        {/* Streak + 30-day + last added — three KPI tiles */}
        ...
        {/* Per-folder breakdown — horizontal bar chart */}
        <section>
